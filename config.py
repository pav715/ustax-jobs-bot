...
LOCATIONS = [
    # ── BROAD ─────────────────────────────────────────────────────
    "India",                # catches all-India postings
    "Remote",               # India remote

    # ── US REMOTE — fully remote jobs supporting work from India ──
    "United States",        # US remote jobs open to India
    "USA Remote",
    "US Remote",
    "Worldwide",
    ...
    "Ahmedabad",            # Gujarat (major city)
    "Chandigarh",           # Haryana & Punjab (shared capital)
    "Gurugram",             # Haryana (major city)
    "Shimla",               # Himachal Pradesh
    "Ranchi",               # Jharkhand
    "Bhopal",               # Madhya Pradesh (capital)
    "Indore",               # Madhya Pradesh (major city)
    "Mumbai",               # Maharashtra (capital)
    "Pune",                 # Maharashtra (major city)
    "Nagpur",               # Maharashtra (major city)
    "Imphal",               # Manipur
    "Shillong",             # Meghalaya
    "Aizawl",               # Mizoram
    "Kohima",               # Nagaland
    ...
    "Noida",                # Uttar Pradesh (major city)
    "Dehradun",             # Uttarakhand
    "Kolkata",              # West Bengal

    # ── 8 UNION TERRITORIES — CAPITALS ───────────────────────────
